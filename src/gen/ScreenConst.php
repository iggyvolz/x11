...
class ScreenConst extends \iggyvolz\x11\XStruct
{
    ...
    public function getDepths(): null|DepthPtr
    {
        return \is_null($this->cdata->depths) ? null : new \iggyvolz\x11\gen\DepthPtr($this->cdata->depths);
    }
    ...
    public function getRootVisual(): null|VisualPtr
    {
        return \is_null($this->cdata->root_visual) ? null : new \iggyvolz\x11\gen\VisualPtr($this->cdata->root_visual);
    }
