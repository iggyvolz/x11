...
class DisplayConst extends \iggyvolz\x11\XStruct
{
    ...
    public function getScreens(): null|ScreenPtr
    {
        return \is_null($this->cdata->screens) ? null : new \iggyvolz\x11\gen\ScreenPtr($this->cdata->screens);
    }
